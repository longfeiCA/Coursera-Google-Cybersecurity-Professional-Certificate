...
Hosts --- LAN --- Switch --- Router --- Firewall --- Modem --- Web service
                     |
                    IDS
...
Chronicle is a cloud-native tool designed to retain, analyze, and search data. (Google Cloud’s SIEM tool)
...
[//]: # (This course is so long... Over 1000 lines of notes.)